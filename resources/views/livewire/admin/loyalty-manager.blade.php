<div class="p-4 lg:p-8 space-y-6">
    @if (!$tenant)
        <div class="max-w-md mx-auto mt-16 p-8 rounded-2xl bg-neutral-900 border border-neutral-800 text-center space-y-3">
            ...
            <p class="text-sm text-neutral-400">Sua conta não está vinculada a nenhuma empresa. Fale com o suporte ou entre com a conta de uma empresa para gerenciar o programa de fidelidade.</p>
        </div>
        @php return; @endphp
    @endif
    <x-admin.page-header
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div wire:ignore>
                            <button
                                ...
                                class="relative inline-flex h-7 w-12 items-center rounded-full transition-colors duration-300 ease-in-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-neutral-950 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
