...
<head>
    ...
    <title>Redefinir Senha - {{ $tenant->name }}</title>
    ...
    <div class="w-full flex">
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-neutral-900 to-neutral-950 p-12 items-center justify-center">
            <div class="max-w-md text-center">
                ...
                <p class="text-neutral-400 leading-relaxed">
                    Defina uma nova senha para sua conta e continue acessando o painel da equipe.
                </p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 min-h-screen">
            <div class="w-full max-w-sm">
                ...
                <h2 class="text-2xl font-bold mb-1">Redefinir Senha</h2>
                <p class="text-sm text-neutral-400 mb-8">Escolha uma nova senha para sua conta</p>
                ...
                <form method="POST" action="{{ route('waiter.reset', ['slug' => $tenant->slug, 'token' => $token]) }}" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $email) }}" required readonly
                               class="w-full px-4 py-2.5 rounded-xl bg-neutral-950 border border-neutral-800 text-neutral-400 placeholder-neutral-500 focus:outline-none transition-all cursor-not-allowed">
                    </div>
                    <div>
