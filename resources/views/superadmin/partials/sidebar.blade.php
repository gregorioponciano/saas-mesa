<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 px-4 pb-4 overflow-y-auto space-y-4">
        ...
        <div>
            <p class="px-4 text-xs font-medium text-neutral-500 uppercase tracking-wider mb-1">Suporte</p>
            <a href="{{ route('superadmin.platform-support') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('superadmin.platform-support') ? 'bg-amber-500/10 text-amber-400' : 'text-neutral-400 hover:text-white hover:bg-neutral-800/50' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span class="flex-1">Suporte às Empresas</span>
                <livewire:superadmin.support-sidebar-counts />
            </a>
        </div>
